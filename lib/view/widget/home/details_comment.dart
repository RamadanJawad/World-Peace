...
class DetailsComment extends StatelessWidget {
  ...
  const DetailsComment({super.key, required this.snapshot2});
      ...
      return Expanded(
        ...
        child: Padding(
          ...
          child: ListView.builder(
              itemCount: snapshot2.data!.commentsCount,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            snapshot2.data!.data!.data![index].user!.name
                                .toString(),
                          ...
                          SizedBox(
                              child: AppPreferences().userId ==
                                      snapshot2.data!.data!.data![index].userId
                                  ? Row(
                                      children: [
                                        IconButton(
                                          onPressed: () {
                                            showDeleteDialog(onConfirm: () {
                                              controller.deleteComment(
                                                  postId: snapshot2.data!.data!
                                                      .data![index].postId!,
                                                  commentId: snapshot2.data!.data!
                                                      .data![index].id!);
                                              Get.back();
                                            });
                                          },
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            snapshot2.data!.data!.data![index].createdAtFormatted
                                .toString(),
                      ...
                      Text(
                        snapshot2.data!.data!.data![index].description!,
